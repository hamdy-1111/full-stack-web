...
<div class=\"container\" style=\"max-width: 600px; margin: 50px auto; background-color: #050A30; border-radius: 10px; padding: 20px; box-shadow: 0 0 10px rgba(0, 0, 0, 0.1);\">\
    <img src=\"/frontend/images/logo/email cover 2.png\" alt=\"\" style=\"display: block; margin: 0 auto; height: calc(100% / 3); margin-bottom: 20px; width: 100%; border-radius: 10px;\">\
    ...
    <p>Your OTP is:</p>\
    <p class=\"otp-code\" id=\"otpCode\" style=\"font-size: 24px; font-weight: bold; color: #0795a3; text-align: center;\">" + otp + "</p>\
    ...
    <div class=\"footer\" style=\"margin-top: 30px; text-align: center; font-size: 14px; display: flex; justify-content: space-evenly; align-items: center;\">\
        <div style=\"display: flex; flex-direction: column; gap: 15px;\">\
            <a href=\"\"><i class=\"fa-brands fa-facebook fa-beat-fade\" style=\"color: #7EC8E3;\"></i></a>\
            <a href=\"\"><i class=\"fa-brands fa-twitter fa-beat-fade\" style=\"color: #7EC8E3;\"></i></a>\
        </div>\
        <div>\
            <p>Best Regards,</p>\
            <p>Digital vibes</p>\
        ...
        <div style=\"display: flex; flex-direction: column; gap: 15px;\">\
            <a href=\"\"><i class=\"fa-brands fa-linkedin-in fa-beat-fade\" style=\"color: #7EC8E3;\"></i></a>\
            <a href=\"\"><i class=\"fa-brands fa-instagram fa-beat-fade\" style=\"color: #7EC8E3;\"></i></a>\
        </div>\
    </div>\
</div>\
